...
class Paginacion {
    ...
    //Obtener el total de paginas que se tienen que mostrar
    public function total_paginas(){
        return ceil($this->total_registros / $this->registros_por_pagina); 
    }

    //Devuelve la pagina anterior hasta la minima disponible
    public function pagina_anterior(){
        $anterior = $this->pagina_actual -1;
        return  ($anterior > 0)  ? $anterior : false;
    }
    //Devuelve la pagina siguiente hasta la maxima disponible
    public function pagina_siguiente(){
        $siguiente = $this->pagina_actual +1;
        return  ($siguiente > $this->total_paginas() ) ? false : $siguiente;
    }
