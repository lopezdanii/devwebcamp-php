<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            <h3 class="footer__logo">&#60DevWebCamp /></h3>

            <p class="footer__texto"> DevWebCamp es una conferencia para desarrolladores de todos los niveles y
                 se lleva a cabo de forma presencial y en línea</p>
        </div>
        
        <nav class="menu-redes"> 
        <!-- _target="_blank" : el enlace se abre en una pestaña nueva    -->
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/lopezdanii">
    ...
    <p class="footer__copyright">DevWebCamp <span class="footer__copyright--regular">
        Todos los derechos reservados <?php echo date ('Y'); ?> </span></p>
</footer>